...
int osdialog_message(osdialog_message_level level, osdialog_message_buttons buttons, const char* message) {
	...
	GtkWidget* dialog = gtk_message_dialog_new(NULL, GTK_DIALOG_DESTROY_WITH_PARENT, messageType, buttonsType, "%s", message);
...
char* osdialog_prompt(osdialog_message_level level, const char* message, const char* text) {
	...
	GtkWidget* dialog = gtk_message_dialog_new(NULL,  GTK_DIALOG_DESTROY_WITH_PARENT, messageType, GTK_BUTTONS_OK_CANCEL, "%s", message);
