...
LIBDYN = -lstdc++ -lgtk-3 -lpango-1.0 -lgdk-3 -lgdk_pixbuf-2.0 -lpangocairo-1.0    \
  -lgio-2.0 -lgobject-2.0 -lglib-2.0  -lGLU -lGL   -lepoxy -ldl -lm -lpthread -lcairo -lopencv_core -lopencv_imgproc -lopencv_imgcodecs -lopencv_highgui $(pkg-config --cflags --libs libcrypto)
